...
<nav class="navbar navbar-expand-lg navbar-dark font-weight-bold stiky-top" style="margin-bottom:20px;background-color:rgba(0,0,0,0.3)">
...
//     <a href='profile.php?action=delete&post_id=".$row['post_id']."'><i class='fas fa-minus-circle' style='color:red'></i></a>
//          <a href='insert.php?action=edit&post_id=".$row['post_id']."'><i class='fas fa-edit' style='color:black'></i></a>
//     <p class ='card-text'>".$_SESSION['username']."</p>
//     <p class='card-subtitle mb-2 text-muted'>".$row['time']."</p>
//   </div>
// </div>";
