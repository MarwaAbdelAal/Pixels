...
$query = $db->prepare("SELECT * FROM posts, users where posts.user_id=users.id ORDER BY time DESC");
...
echo "<div class='card border-primary mb-3 col-sm-6 mx-auto' style='max-width: 30rem;'>
  ...
  <div class='card-footer bg-transparent border-primary'>".$row['username']."</div>
</div>";
